...
export default async function handler(req, res) {
    ...
    try {
      ...
      if (headerApiKey && EXPECTED_API_KEY) {
        ...
        if (
          (body.merchant_code && EXPECTED_MERCHANT && body.merchant_code === EXPECTED_MERCHANT) ||
          (body.api_key && EXPECTED_API_KEY && body.api_key === EXPECTED_API_KEY)
        ) {
          verified = true;
        }
      }
